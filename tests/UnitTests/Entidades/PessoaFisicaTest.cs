...
namespace UnitTests.Entidades
{
    public class PessoaFisicaTest
    {
        ...
        public void Deve_Adicionar_Notificacao_Quando_CPF_Invalido()
        {
            ...
            var sut = new PessoaFisica("nome", "3330909", new DateTime(1990, 10, 20), cpf);
        ...
        public void Deve_Adicionar_Notificacao_Quando_RG_Nao_Informado()
        {
            ...
            var sut = new PessoaFisica("nome", "", dataNascimento, cpf);
            var esperado = new List<string>() { "RG é obrigatório" };

            Assert.Equal(esperado, sut.Notificacoes);

            sut = new PessoaFisica("nome", null, dataNascimento, cpf);
        ...
        {
            var cpf = new CPF("89071787044");
            var sut = new PessoaFisica("nome", "3330909", new DateTime(), cpf);
